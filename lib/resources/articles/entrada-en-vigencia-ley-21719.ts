...
export const ENTRADA_EN_VIGENCIA_LEY_21719: ResourceArticle = {
  slug: "entrada-en-vigencia-ley-21719",
  type: "satelite",
  title: "¿Cuándo entra en vigencia la Ley 21.719? Fecha y qué hacer antes",
  metaTitle:
    "Cuándo entra en vigencia la Ley 21.719: fecha y plan de preparación",
  description:
    "La Ley 21.719 entra en vigencia el 1 de diciembre de 2026. Qué significa esa fecha, por qué conviene anticiparse y qué pasos de preparación seguir antes de que empiece a regir.",
  keyword: "cuándo entra en vigencia ley 21.719",
  summary:
  ...
  sections: [
    {
      heading: "La fecha de entrada en vigencia: 1 de diciembre de 2026",
      paragraphs: [
    ...
    {
      heading: "Por qué conviene empezar antes de la fecha límite",
      paragraphs: [
    ...
    {
      heading: "Qué hacer antes: checklist de preparación priorizado",
      paragraphs: [
    ...
    {
      heading: "Qué pasa si no se cumple a tiempo",
      paragraphs: [
  ...
  faq: [
    {
      ...
      a: "El 1 de diciembre de 2026. Desde esa fecha, la Agencia de Protección de Datos Personales puede fiscalizar y sancionar a las organizaciones que no cumplan.",
    },
    {
      q: "¿Desde cuándo pueden multarme?",
      a: "Las multas solo pueden aplicarse por incumplimientos posteriores a la entrada en vigencia de la ley, el 1 de diciembre de 2026, una vez que la Agencia de Protección de Datos Personales quede operativa y ejerza su potestad fiscalizadora.",
    },
    {
      q: "¿La Ley 21.719 aplica a mi empresa si es pequeña?",
      a: "Sí. La ley no distingue por tamaño de la organización: aplica a toda entidad, pública o privada, que trate datos personales. El nivel de exigencia de las medidas es proporcional al riesgo del tratamiento, pero la obligación de cumplir rige igual para empresas pequeñas.",
    },
    {
      q: "¿Cuánto tiempo toma prepararse antes de la fecha límite?",
      a: "Depende del punto de partida de cada organización. Como referencia, avanzar en las brechas más comunes (política de tratamiento, RAT, seguridad y contratos con proveedores) suele tomar entre varias semanas y algunos meses cuando se aborda de forma ordenada y priorizada. // REVISAR: plazo referencial estimado, no un plazo legal fijado por la norma.",
    },
  ],
