...
export const LEY_21719: ResourceArticle = {
  ...
  metaTitle: "Ley 21.719: guía completa de cumplimiento 2026",
  description:
    "Qué exige la Ley 21.719 de protección de datos en Chile, a quién aplica, sus principios, obligaciones clave y cómo empezar a cumplir. Guía práctica y actualizada.",
  keyword: "ley 21.719",
  summary:
  ...
  sections: [
    ...
    {
      heading: "Los principios que ordenan la ley",
      paragraphs: [
    ...
    {
      heading: "Obligaciones clave para las empresas",
      paragraphs: [
      ...
      list: {
        ordered: false,
        items: [
          "Informar el tratamiento (Art. 14 bis y 14 ter): desde el primer contacto con el titular, y de forma permanente mediante una política de tratamiento pública con contenidos mínimos —responsable, finalidades, bases de licitud, destinatarios, plazos de conservación y transferencias internacionales, entre otros—.",
    ...
    {
      heading: "Datos sensibles y categorías con protección reforzada",
      paragraphs: [
    ...
    {
      heading: "La Agencia de Protección de Datos Personales y las sanciones",
      paragraphs: [
        ...
        // REVISAR: confirmar con el equipo legal el detalle exacto de la clasificación de infracciones (leves/graves/gravísimas) y los rangos de multa asociados antes de publicar cifras; esta sección se mantiene deliberadamente general por no contar con esa base confirmada en lib/legal.
    ...
    {
      heading: "Cómo empezar a cumplir",
      paragraphs: [
  ...
  faq: [
    {
      ...
      a: "El 1 de diciembre de 2026. Conviene comenzar la adecuación con anticipación, porque levantar el inventario de datos, ajustar contratos con proveedores y definir procedimientos internos toma tiempo.",
    },
    {
      q: "¿Mi empresa debe cumplirla si es pequeña?",
      a: "Sí. La ley no distingue por tamaño de la organización: aplica a toda entidad que trate datos personales, aunque el nivel de exigencia concreto es proporcional al riesgo del tratamiento que realiza.",
    },
    {
      q: "¿Qué cambia respecto de la Ley 19.628 anterior?",
      a: "La Ley 21.719 reforma la Ley 19.628 e introduce, entre otros cambios, la Agencia de Protección de Datos Personales como regulador con potestad fiscalizadora, un catálogo de derechos ampliado para los titulares, obligaciones expresas de reporte de incidentes de seguridad y un régimen reforzado para datos sensibles.",
    },
    {
      q: "¿Qué es el RAT y por qué es obligatorio?",
      a: "El Registro de Actividades de Tratamiento (RAT) es el inventario de qué datos personales trata la organización, con qué finalidad, quién accede a ellos y por cuánto tiempo se conservan. Es la base para poder demostrar cumplimiento ante la Agencia y para responder correctamente a los titulares que ejercen sus derechos.",
    },
    {
      q: "¿Qué pasa si mi empresa sufre una filtración de datos?",
      a: "El Art. 14 sexies obliga a reportar la vulneración a la Agencia por los medios más expeditos y sin dilaciones indebidas cuando existe un riesgo razonable para las personas. Si la filtración afecta datos sensibles, de menores de 14 años o financieros, también debe notificarse a los titulares afectados, y la organización debe mantener un registro de estos incidentes.",
    },
  ],
  related: [
    "multas-ley-21719",
    "que-es-el-rat",
    "entrada-en-vigencia-ley-21719",
    "proteccion-datos-salud",
  ],
  author: {
